...
$(document).ready(function () {
    ...
    $("input[name='ref2']").click(function() {
        ref2 = $(this).val();
        if(ref2 == "Yes") {
            $("#referencesTwo").slideDown();
        } else if(ref2 == "No") {
            $("#referencesTwo").slideUp();
        }
    });
    ...
    $("input[name='ref3']").click(function() {
        ref3 = $(this).val();
        if(ref3 == "Yes") {
            $("#referencesThree").slideDown();
        } else if(ref3 == "No") {
            $("#referencesThree").slideUp();
        }
    });
    ...
    $("input[name='prevEmpTwo']").click(function() {
        job2 = $(this).val();
        if(job2 == "Yes") {
            $("#previousEmploymentTwo").slideDown();
        } else if(job2 == "No") {
            $("#previousEmploymentTwo").slideUp();
        }
    });
